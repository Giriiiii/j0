  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        Your Journey, Your Voice. <br /> Your Story, Redefined.
        </h1>
        <p className="text-lg md:text-xl text-green-800 mb-8">
        Express your thoughts, monitor your moods, and reflect on your journey in a secure and elegant space.
        </p>
        ...
        <Card className="bg-gradient-to-r from-green-100 to-amber-100">
          <CardContent className="p-12 text-center">
            <h2 className="text-3xl font-bold text-green-900 mb-6">
              Start your jØ-urney Today
            </h2>
            <p className="text-lg text-green-700 mb-8 max-w-2xl mx-auto">
              Join writers who have already discovered the power of
              digital journaling.
            </p>
